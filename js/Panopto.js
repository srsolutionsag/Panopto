var Panopto = {
    ...
    playVideo: function (sid, is_playlist) {
        ...
        $modal.modal('show');
        var $iframe = `<iframe src="${ Panopto.base_url }/Panopto/Pages/Embed.aspx?${(is_playlist ? 'p' : '')}id=${sid}&instance=${this.instance_name}" width="720" height="405" style="padding: 0px; border: 1px solid #464646;" frameborder="0" allowfullscreen allow="autoplay"></iframe>`;
